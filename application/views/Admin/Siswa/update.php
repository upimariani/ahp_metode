			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<div class="card card-primary">
						...
						<!-- /.card-header -->
						<!-- form start -->
						<form role="form" action="<?= base_url('Admin/cSiswa/edit/' . $siswa->id_siswa) ?>" method="POST">
							<div class="card-body">
								<div class="row">
									<div class="col-lg-6">
								...
								<div class="row">
									...
									<div class="col-lg-6">
										<div class="form-group">
											...
											<input type="number" value="<?= $siswa->angkatan ?>" name="angkatan" class="form-control" placeholder="Masukkan Tahun Angkatan">
