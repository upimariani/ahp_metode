<aside class="main-sidebar sidebar-light-primary elevation-4">
	...
	<a href="#" class="brand-link">
		<span class="brand-text font-weight-dark text-center"> Selamat Datang, Kepsek</span>
	</a>
	...
	<div class="sidebar">
		...
		<nav class="mt-2">
			<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
				...
				<li class="nav-item">
					<a href="<?= base_url('KepalaSekolah/cDashboardKepalaSekolah') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'KepalaSekolah' && $this->uri->segment(2) == 'cDashboardKepalaSekolah') {
																											echo 'active';
																										}  ?>">
